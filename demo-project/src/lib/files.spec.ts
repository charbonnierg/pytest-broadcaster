...
describe.concurrent("Tree", () => {
  ...
  describe.concurrent("simple tree with multiple items", () => {
    it("should return true when item is included", () => {
      const tree = makeTree()
  ...
  describe.concurrent("complex tree wth several suites", () => {
    it("should return true when item is included", () => {
      const tree = makeTree()
      const item1 = makeExample()
  ...
  describe.concurrent(
    "complex tree with several suites and nested suites",
    () => {
      it("should return true when item is included", () => {
        const tree = makeTree()
        const item1 = makeExample()
      ...
      it("should return true when item is included according to prefix", () => {
        ...
        expect(tree.includes(item2.node_id, "parent")).toBe(true)
        expect(tree.includes(item3.node_id, "parent")).toBe(true)
        expect(tree.includes(item2.node_id, "parent/test.py::suite1")).toBe(
          true,
        )
        expect(tree.includes(item3.node_id, "parent/test.py::suite2")).toBe(
          true,
        )
        expect(
      ...
      it("should return false when item is not included according to prefix", () => {
        ...
        expect(tree.includes(item2.node_id, "parent")).toBe(true)
        expect(tree.includes(item3.node_id, "parent")).toBe(true)
        expect(tree.includes(item3.node_id, "parent/test.py::suite1")).toBe(
          false,
        )
        expect(tree.includes(item2.node_id, "parent/test.py::suite2")).toBe(
          false,
        )
        expect(
  ...
  describe.concurrent("simple tree with parametrization and suite", () => {
